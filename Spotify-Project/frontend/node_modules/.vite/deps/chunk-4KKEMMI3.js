...
var ListContext = React14.createContext(null);
if (true) {
...
function deepClone(source) {
  if (React26.isValidElement(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React26.isValidElement(source[key])) {
...
var maybeReactUseId2 = React29["useId".toString()];
...
var ClassNameConfiguratorContext = React38.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass4) {
  ...
  } = React38.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
var useInsertionEffect2 = React40["useInsertionEffect"] ? React40["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React40.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-489459f2.browser.development.esm.js
var EmotionCacheContext = React41.createContext(
...
var ThemeContext = React41.createContext({});
{
...
var Emotion = withEmotionCache(function(props, cache2, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, void 0, React41.useContext(ThemeContext));
  ...
  return React41.createElement(React41.Fragment, null, React41.createElement(Insertion, {
    cache: cache2,
    serialized,
    isStringTag: typeof WrappedComponent === "string"
  }), React41.createElement(WrappedComponent, newProps));
});
{
...
var jsx = function jsx2(type, props) {
  ...
  if (props == null || !hasOwn.call(props, "css")) {
    return React42.createElement.apply(void 0, args);
  }
  ...
  return React42.createElement.apply(null, createElementArgArray);
};
(function(_jsx18) {
  var JSX;
...
var Global = withEmotionCache(function(props, cache2) {
  ...
  var serialized = serializeStyles([styles], void 0, React42.useContext(ThemeContext));
  var sheetRef = React42.useRef();
...
var ClassNames = withEmotionCache(function(props, cache2) {
  ...
  var content = {
    css: css2,
    cx,
    theme: React42.useContext(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  return React42.createElement(React42.Fragment, null, React42.createElement(Insertion3, {
    cache: cache2,
    serializedArr
  }), ele);
});
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache2, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React43.useContext(ThemeContext);
      }
      if (typeof props.className === "string") {
      ...
      return React43.createElement(React43.Fragment, null, React43.createElement(Insertion5, {
        cache: cache2,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), React43.createElement(FinalTag, newProps));
    });
...
function useTheme2(defaultTheme5 = null) {
  const contextTheme = React46.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React48.forwardRef(function Box3(inProps, ref) {
...
var ThemeContext2 = React50.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React51.useContext(ThemeContext_default);
  if (true) {
    React51.useDebugValue(theme);
  }
  return theme;
}
...
var PropsContext = React54.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React57.useCallback((mode) => {
  ...
  const setColorScheme = React57.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React57.useCallback((event) => {
  ...
  const mediaListener = React57.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React58.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = React58.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const hasMounted = React58.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React58.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React58.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime12.jsxs)(React58.Fragment, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React59.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React60.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React60.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React60.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime14.jsx)(GridRoot, _extends({
      ...
      children: React60.Children.map(children, (child) => {
        if (React60.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React61.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React61.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var _excluded15 = ["cssVarPrefix", "breakpoints", "spacing", "components", "variants", "shouldSkipGeneratingVar"];
...
function extendTheme(themeOptions) {
  ...
  } = _ref, scalesInput = _objectWithoutPropertiesLoose(_ref, _excluded15);
...
var RowListContext = React64.createContext(false);
if (true) {
...
var VariantColorContext = React65.createContext(void 0);
if (true) {
...
function useVariantColor(instanceVariant, instanceColor, alwaysInheritColor = false) {
  const value = React65.useContext(VariantColorContext);
  ...
  result.color = instanceColor || (alwaysInheritColor ? color2 : result.color);
  return result;
}
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4KKEMMI3.js.map
